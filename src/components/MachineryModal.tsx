            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between py-2 border-b border-border">
                  ...
                  <span className="font-medium">{machinery.specs.Motor}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-border">
                  <span className="text-muted-foreground">Potencia Motor:</span>
                  <span className="font-medium">{machinery.specs.PotenciaMotor}</span>
                </div>
                <div className="flex justify-between py-2 border-b border-border">
                ...
                <div className="flex justify-between py-2 border-b border-border">
                  <span className="text-muted-foreground">Tiempo de Ciclo:</span>
                  <span className="font-medium">{machinery.specs.TiempoCiclo}</span>
                </div>
              </div>
